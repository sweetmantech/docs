...
Non-hosted integrators wiring **sales** directly onchain should use the canonical **Fixed Price Sale** strategy and **ERC-20 minter** addresses (and **`mintFee()`** semantics) documented in [Protocol Deployments](/protocol/protocol-deployments#sales-strategies-and-erc-20-minters).
