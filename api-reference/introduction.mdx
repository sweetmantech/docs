---
title: 'Introduction'
description: 'API documentation for the In•Process platform - Browse moments and collections from timelines'
---

## Welcome

Welcome to the In•Process API documentation. In•Process is a platform for creating, sharing, and collecting moments on-chain. Browse moments from timelines, explore collections, and interact with the in•process collective ecosystem.
...
<Note>
  You can also create API keys programmatically using the [Create API Key endpoint](/artists/api-keys/create).
</Note>
...
<CardGroup cols={2}>
  ...
  >
    Browse moments from artist timelines or the collective timeline
  </Card>
  <Card
  ...
  >
    Explore collections created by artists
  </Card>
</CardGroup>
