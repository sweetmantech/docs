...
1. **File Size**: Turbo uploads are paid with Credits (not AR tokens directly). Larger files consume more credits. See the [Turbo Credits documentation](https://docs.ar.io/build/upload/turbo-credits) to learn how to top up your balance.
...
- **Insufficient Turbo Credits**: Ensure your Arweave wallet has enough Turbo Credits for the upload
