...
This guide uses the [In•Process Arweave Proxy API](/api-reference/arweave/proxy) to upload chunks to Arweave. The proxy forwards requests to `https://arweave.net`, so your client never connects directly to the Arweave gateway.
